  ...
  <div id="site_content">   
    ...
    <div class="sidebar">
          <div class="sidebar_item">
            ...
            <p>Enter the LAST and FIRST name of the currently existing student you would like to edit.  Then choose which field to edit and enter in the modified data.</p>
...
?>
		...
		<option value="grade">Grade</option>
  		<br><br>
		Modified Data: <input type="text" name="input" value="<?php echo htmlspecialchars($value[0]); ?>"><br><br>
		<input type="submit">
